...
## 核心特性
- **合法合規**：透過 [PCC-API](https://pcc-api.openfun.app/) 取得政府電子採購網公開資料，遵循開放資料精神與授權規範。
...
- **智慧去重**：針對 API 回傳之搜尋結果進行案號去重，若有重複資料則優先保留日期較新之紀錄，確保資訊準確。
...
3. **資料去重**：針對搜尋結果中出現的相同案號，優先保留日期較新的紀錄。
